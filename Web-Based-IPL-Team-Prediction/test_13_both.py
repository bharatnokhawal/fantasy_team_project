...
def predict_runs_and_wickets(player_name, against_team, models_runs, models_wickets, data, encoder, kmeans_runs, kmeans_wickets):
...
predicted_runs, predicted_wickets = predict_runs_and_wickets(player_name, against_team, models_runs, models_wickets, data, encoder, kmeans_runs, kmeans_wickets)
...
if predicted_runs is not None and predicted_wickets is not None:
    ...
    print(f"Predicted wickets taken by {player_name} against {against_team}: {predicted_wickets:.2f}")
else:
